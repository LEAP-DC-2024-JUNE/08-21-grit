...
const Experience = () => {
  return (
    <div className="w-full px-[16px] py-[60px] lg:py-[60px] lg:px-[80px] lg:justify-center bg-[#F9FAFB] dark:bg-[#111827] dark:text-white">
      <div className="flex flex-col gap-[24px] lg:gap-[48px] lg:px-[32px] items-center ">
        <button className="w-[105px] h-[28px] rounded-[12px] bg-[#E5E7EB] font-normal text-black text-center dark:bg-[#CBD5E1]">
          Experience
        </button>
      ...
      <div className="flex flex-col gap-6">
        {experiences.map((experience, index) => {
          return <Card2 key={index} {...experience} />;
        })}
      </div>
    </div>
  );
